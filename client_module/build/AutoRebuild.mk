# Automatic rebuild of ConGFS client modules on kernel change.


AUTO_REBUILD_KVER_FILE := auto_rebuild_kernel.ver
AUTO_REBUILD_KVER_CURRENT = $(shell uname -srvmpi)

AUTO_REBUILD_LOG_PREFIX := "ConGFS Client Auto-Rebuild:"

# config file (keys)
AUTO_REBUILD_CONF_FILE := /etc/congfs/congfs-client-autobuild.conf
...
# add build dependency if rebuild has conn enabled in config file
