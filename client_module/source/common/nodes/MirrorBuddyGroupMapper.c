...
CONGFS_RBTREE_FUNCTIONS(static, _MirrorBuddyGroupMapper, struct MirrorBuddyGroupMapper,
      mirrorBuddyGroups,
      uint16_t,
...
{
   MirrorBuddyGroup* buddyGroup;
   CONGFS_RBTREE_FOR_EACH_ENTRY(buddyGroup, &this->mirrorBuddyGroups, _rb_node)
   {
