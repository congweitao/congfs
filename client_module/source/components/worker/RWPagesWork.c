...
#define RWPagesWorkQueue_SUB_NAME CONGFS_MODULE_NAME_STR "-rwPgWQ" // read-pages-work-queue
   ...
   FileHandleType* outHandleType, RemotingIOInfo* outIOInfo)
{
   ...
   int openFlags = (rwType == CONGFS_RWTYPE_WRITE) ? OPENFILE_ACCESS_WRITE : OPENFILE_ACCESS_READ;
