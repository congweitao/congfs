...
#define CONGFS_COMMKIT_MSGBUF_SIZE         4096
...
// #define CONGFS_COMMKIT_DEBUG 0b010

#ifndef CONGFS_COMMKIT_DEBUG
#define CONGFS_COMMKIT_DEBUG 0
#endif

#ifdef CONGFS_COMMKIT_DEBUG
...
struct CommKitContextOps
{
   ...
   // return >= for success, 0 to advance, or negative congfs error code
...
void __FhgfsOpsCommKitCommon_pollStateSocks(CommKitContext* context, size_t numStates)
{
   ...
   CONGFS_BUG_ON_DEBUG(numWaiters > numStates, "numWaiters > numStates should never happen");
