...
#define CONGFS_IOCTL_CFG_MAX_PATH 4096 // just an arbitrary value, has to be identical in user space
#define CONGFS_IOCTL_TEST_STRING  "_FhGFS_" /* copied to user space by CONGFS_IOC_TEST_IS_FHGFS to
...
#define CONGFS_IOCNUM_GETVERSION_OLD           1 // value from FS_IOC_GETVERSION in linux/fs.h
#define CONGFS_IOCNUM_GETVERSION               3
#define CONGFS_IOCNUM_GET_CFG_FILE            20
#define CONGFS_IOCNUM_CREATE_FILE             21
#define CONGFS_IOCNUM_TEST_IS_FHGFS           22
...
#define CONGFS_IOC_GETVERSION     _IOR( \
   CONGFS_IOCTYPE_ID, CONGFS_IOCNUM_GETVERSION, long)
#define CONGFS_IOC32_GETVERSION   _IOR( \
   CONGFS_IOCTYPE_ID, CONGFS_IOCNUM_GETVERSION, int)
...
#define CONGFS_IOC_TEST_IS_FHGFS  _IOR( \
   CONGFS_IOCTYPE_ID, CONGFS_IOCNUM_TEST_IS_FHGFS, char[CONGFS_IOCTL_TEST_BUFLEN])
...
#define CONGFS_IOC_MKFILE_STRIPEHINTS      _IOW( \
   CONGFS_IOCTYPE_ID, CONGFS_IOCNUM_MKFILE_STRIPEHINTS, struct BeegfsIoctl_MkFileWithStripeHints_Arg)
...
#define CONGFS_IOC_GETENTRYINFO             _IOR( \
   ...
   #define CONGFS_IOC_GETVERSION_OLD          FS_IOC_GETVERSION // predefined in linux/fs.h
#else // old kernels didn't have FS_IOC_GETVERSION
   #define CONGFS_IOC_GETVERSION_OLD          _IOR('v', CONGFS_IOCNUM_GETVERSION_OLD, long)
#endif

#ifdef CONFIG_COMPAT
   #ifdef FS_IOC32_GETVERSION
      #define CONGFS_IOC32_GETVERSION_OLD     FS_IOC32_GETVERSION // predefined in linux/fs.h
   #else // old kernels didn't have FS_IOC32_GETVERSION
      #define CONGFS_IOC32_GETVERSION_OLD     _IOR('v', CONGFS_IOCNUM_GETVERSION_OLD, int)
   #endif
#endif
