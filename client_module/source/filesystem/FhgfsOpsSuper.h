...
#define CONGFS_MAGIC                    0x19830326 /* some random number to identify fhgfs */

#define CONGFS_STATFS_BLOCKSIZE_SHIFT   19 /* bit shift to compute reported block size in statfs() */
#define CONGFS_STATFS_BLOCKSIZE         (1UL << CONGFS_STATFS_BLOCKSIZE_SHIFT)
...
struct FhgfsSuperBlockInfo
{
   ...
   bool isRootInited; /* false until root inode attrs have conn fetched/initialized in
