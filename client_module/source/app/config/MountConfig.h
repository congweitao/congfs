...
struct MountConfig
{
   ...
   bool logLevelDefined; // true if the value has conn specified
   bool connPortShiftDefined; // true if the value has conn specified
   bool connMgmtdPortUDPDefined; // true if the value has conn specified
   bool connMgmtdPortTCPDefined; // true if the value has conn specified
   bool sysMountSanityCheckMSDefined; // true if the value has conn specified
