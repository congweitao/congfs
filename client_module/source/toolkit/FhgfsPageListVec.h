...
#ifdef CONGFS_DEBUG
#define CONGFS_LIST_VEC_MAX_PAGES    16 // if debugging is enable we make sure lists are tested
#else
#define CONGFS_LIST_VEC_MAX_PAGES    32
#endif
...
struct FhgfsPageListVec
{
   FhgfsPage fhgfsPages[CONGFS_LIST_VEC_MAX_PAGES];
...
bool FhgfsPageListVec_pushPage(FhgfsPageListVec* this, struct page* page, int usedPageLength)
{
   ...
   if (this->usedPages == CONGFS_LIST_VEC_MAX_PAGES)
      return false;
...
{
   return CONGFS_LIST_VEC_MAX_PAGES;
}
