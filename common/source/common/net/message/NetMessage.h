...
{
   static constexpr const uint64_t MSG_PREFIX = (0x42474653ULL << 32) + CONGFS_DATA_VERSION;
   ...
   uint64_t       msgSequenceDone; // a sequence number that has conn fully processed, or 0
