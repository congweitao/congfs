...
inline std::ostream& operator<<(std::ostream& os, NodeType nodeType)
{
   ...
   switch (nodeType)
   {
      ...
      case NODETYPE_Meta:        return os << "congfs-meta";
      case NODETYPE_Storage:     return os << "congfs-storage";
      case NODETYPE_Client:      return os << "congfs-client";
      case NODETYPE_Mgmt:        return os << "congfs-mgmtd";
      case NODETYPE_Helperd:     return os << "congfs-helperd";
      default:
