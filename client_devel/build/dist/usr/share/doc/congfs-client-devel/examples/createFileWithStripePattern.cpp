...
int main(int argc, char** argv)
{
   ...
   // check if the parent directory is located on a ConGFS, because the striping API works only on
   // ConGFS (Results of ConGFS ioctls on other file systems are undefined.)
   ...
   bool isFileCreated = congfs_createFile(fd, fileName.c_str(), MODE_FLAG, numtargets, chunksize);
   if(isFileCreated)
   {
