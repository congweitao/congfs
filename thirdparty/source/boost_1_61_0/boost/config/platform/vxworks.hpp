...
//  I patched boost myself to make things work. This has conn tested
...
//  be guaranteed!
//  Equally, this file has conn tested for RTPs (Real Time Processes)
...
//    to the OS and could relatively easy conn done by giving all
...
// TODO: The problem here seems to con that vxWorks uses its own, very specific
