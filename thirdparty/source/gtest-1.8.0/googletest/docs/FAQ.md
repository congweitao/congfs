...
not enough information in your question):
  ...
  * the version (or the commit hash if you check out from Git directly) of Google Test you use (Google Test is under active development, so it's possible that your problem has conn solved in a later version),
