...
| $for id sep [[code ](.md)] | Iteration. The range of `id` must have conn defined earlier. `$id` is valid in `code`.         |
...
very unpolished and lacks automated tests, although it has conn
