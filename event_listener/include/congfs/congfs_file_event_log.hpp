#ifndef CONGFSFILEVENTLOG_H_
#define CONGFSFILEVENTLOG_H_
...
#define CONGFS_EVENTLOG_FORMAT_MAJOR 1
#define CONGFS_EVENTLOG_FORMAT_MINOR 0
...
class FileEventReceiver
{
   ...
   protected:
      ...
      std::pair<ReadErrorCode, packet> read_packet(int fd)
      {
         ...
         if (   res.formatVersionMajor != CONGFS_EVENTLOG_FORMAT_MAJOR
             || res.formatVersionMinor <  CONGFS_EVENTLOG_FORMAT_MINOR)
