...
#define MODEIOCTL_ARG_IOCTLTYPE_TESTISCONGFS    "testiscongfs"
...
int ModeIoctl::execute()
{
   ...
   if(ioctlTypeStr == MODEIOCTL_ARG_IOCTLTYPE_TESTISCONGFS)
...
void ModeIoctl::printHelp()
{
   ...
   std::cout << "  <path>                 Path to a file or directory inside a ConGFS mount." << std::endl;
   ...
   std::cout << "                         getmountid, testiscongfs, getstripeinfo," << std::endl;
   std::cout << "                         getstripetargets)" << std::endl;
   std::cout << std::endl;
   std::cout << "USAGE EXAMPLE" << std::endl;
   std::cout << "=============" << std::endl;
   std::cout << " Example: Retrieve runtime config file from ConGFS mountpoint" << std::endl;
   std::cout << "  $ congfs-ctl --ioctl --type=getruntimeconfigfile /mnt/congfs" << std::endl;
}
