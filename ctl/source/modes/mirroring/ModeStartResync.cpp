...
void ModeStartResync::printHelp()
{
   ...
   std::cout << "  # congfs-ctl --startresync --nodetype=storage --targetid=10" << std::endl;
   std::cout << std::endl;
   std::cout << " Example: Resync the changes in buddy group with ID 2 of the last 5 days" << std::endl;
   std::cout << "  # congfs-ctl --startresync --nodetype=storage --mirrorgroupid=2 --timespan=5d" << std::endl;
   std::cout << std::endl;
   std::cout << " Example: Resync the changes in buddy group with ID 2 of the last 36 hours" << std::endl;
   std::cout << "  # congfs-ctl --startresync --nodetype=storage --mirrorgroupid=2 --timespan=36h" << std::endl;
   std::cout << std::endl;
   std::cout << " Example: Perform a full resync of target with ID 5" << std::endl;
   std::cout << "  # congfs-ctl --startresync --nodetype=storage --targetid=5 --timestamp=0" << std::endl;
}
