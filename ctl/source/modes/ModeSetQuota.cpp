...
void ModeSetQuota::printHelp()
{
   ...
   std::cout << "limit is set by the congfs-ctl this quota limits are used. User and group" << std::endl;
   ...
   std::cout << "  # congfs-ctl --setquota --sizelimit=50M --inodelimit=50 --storagepoolid=2 \\" << std::endl;
   ...
   std::cout << "  # congfs-ctl --setquota --gid --file=/tmp/quota_limits.txt --storagepoolid=1" << std::endl;
   std::cout << std::endl;
   ...
   std::cout << "  # congfs-ctl --setquota --uid --sizelimit=20M --inodelimit=500 --storagepoolid=1 \\" << std::endl;
   ...
   std::cout << "  # congfs-ctl --setquota --sizelimit=unlimited --inodelimit=5000 --storagepoolid=2 --gid \\" << std::endl;
   ...
   std::cout << "  # congfs-ctl --setquota --uid --sizelimit=20M --inodelimit=500 --default \\" << std::endl;
   ...
   std::cout << "  # congfs-ctl --setquota --uid --sizelimit=reset --inodelimit=reset 100" << std::endl;
}
