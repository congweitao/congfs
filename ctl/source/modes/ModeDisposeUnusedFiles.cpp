...
void ModeDisposeUnusedFiles::printHelp()
{
   ...
   std::cout << " This mode purges remains of old files, which have conn unlinked by the user" << std::endl;
   ...
   std::cout << "  # congfs-ctl --disposeunused --printfiles --printstats" << std::endl;
}
