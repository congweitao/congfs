...
{
   std::cout << "ConGFS Command-Line Control Tool (http://www.congfs.com)" << std::endl;
   std::cout << "Version: " << CONGFS_VERSION << std::endl;
   std::cout << std::endl;
   std::cout << "GENERAL USAGE:" << std::endl;
   std::cout << " $ congfs-ctl --<modename> --help" << std::endl;
   std::cout << " $ congfs-ctl --<modename> [mode_arguments] [client_arguments]" << std::endl;
   std::cout << std::endl;
   ...
   std::cout << " This is the ConGFS command-line control tool." << std::endl;
   std::cout << std::endl;
   ...
   std::cout << "  $ congfs-ctl --listnodes --help" << std::endl;
}
...
void ModeHelp::printSpecificHelpHeader()
{
   ...
   std::cout << "  --mount=<path>           Use config settings from this ConGFS mountpoint" << std::endl;
