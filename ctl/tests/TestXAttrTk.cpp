...
TEST (XAttrTk_getXAttrNames, properly_forwards_path)
{
   ...
   congfs::testing::syscall::scoped_override const _llistxattr
...
TEST (XAttrTk_getXAttrValue, properly_forwards_path_and_name)
{
   ...
   congfs::testing::syscall::scoped_override const _lgetxattr
      ( congfs::testing::syscall::lgetxattr
...
TEST (XAttrTk_setXAttrs, properly_forwards_parameters)
{
   ...
   int seen_flags;
   congfs::testing::syscall::scoped_override const _lsetxattr
      ( congfs::testing::syscall::lsetxattr
