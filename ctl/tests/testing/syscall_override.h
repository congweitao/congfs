...
//! Usage: include and use `congfs::testing::syscall::scoped_override`
//! to override a syscall for the current scope:
//!
//! congfs::testing::syscall::scoped_override const llistxattr_override
//!   ( congfs:testing::syscall::llistxattr
            ...
            struct override_hook
         {
            ...
            override_hook (const char* name)
               : original ( reinterpret_cast<Signature*>
                              (congfs::syscall::dlsym_next (name))
                          )
               , current (original)
            {}
         };
...
{
   return congfs::testing::syscall::llistxattr.current
...
{
   return congfs::testing::syscall::lgetxattr.current
...
{
   return congfs::testing::syscall::lsetxattr.current
