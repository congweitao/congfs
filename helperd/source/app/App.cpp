...
#define APP_SYSLOG_IDENTIFIER    "congfs-helperd"
...
void App::run()
{
   ...
   catch (InvalidConfigException& e)
   {
      ...
      std::cerr << std::endl;
      std::cerr << "[ConGFS Helper Daemon Version: " << CONGFS_VERSION << std::endl;
      std::cerr << "Refer to the default config file (/etc/congfs/congfs-helperd.conf)" << std::endl;
...
void App::logInfos()
{
   ...
   log->log(Log_CRITICAL, std::string("ConGFS Helper Daemon Version: ") + CONGFS_VERSION);
