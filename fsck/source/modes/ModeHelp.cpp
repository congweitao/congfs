...
{
   std::cout << "ConGFS File System Check (http://www.congfs.com)" << std::endl;
   std::cout << "Version: " << CONGFS_VERSION << std::endl;
   std::cout << std::endl;
   std::cout << "GENERAL USAGE:" << std::endl;
   std::cout << " $ congfs-fsck --<modename> --help" << std::endl;
   std::cout << " $ congfs-fsck --<modename> [mode_arguments] [client_arguments]" << std::endl;
   std::cout << std::endl;
   std::cout << "MODES:" << std::endl;
   std::cout << " --checkfs     => Perform a full check and optional repair of " << std::endl;
   std::cout << "                  a ConGFS instance." << std::endl;
   ...
   std::cout << " This is the ConGFS file system consistency check and repair tool." << std::endl;
   std::cout << std::endl;
   ...
   std::cout << std::endl;
   std::cout << " (Running congfs-fsck requires root privileges.)" << std::endl;
   std::cout << std::endl;
   std::cout << " Example: Show help for mode \"--checkfs\"" << std::endl;
   std::cout << "  $ congfs-fsck --checkfs --help" << std::endl;
}
...
void ModeHelp::printSpecificHelpHeader()
{
   ...
   std::cout << " --cfgFile=<path>         Path to ConGFS client config file." << std::endl;
