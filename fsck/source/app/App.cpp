...
#define APP_SYSLOG_IDENTIFIER    "congfs-fsck"
...
void App::runNormal()
{
   ...
   if (runModeEnum == RunMode_CHECKFS || runModeEnum == RunMode_ENABLEQUOTA)
   {
      ...
      {
         std::cerr << std::endl 
               << "Running congfs-fsck requires root privileges." 
   ...
   catch (ComponentInitException& e)
   {
      ...
      FsckTkEx::fsckOutput("A hard error occurred. ConGFS Fsck will abort.",
   ...
   {
      FsckTkEx::fsckOutput("Unrecoverable error. ConGFS Fsck will abort.",
