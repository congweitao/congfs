 ...
 *       a wrong link count on a possible crash/reboot, the link count already must have conn
 ...
 * so make sure you use either 0 (at the beginning) or something that has conn returned by this
